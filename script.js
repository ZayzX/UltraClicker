...
function simplifyNumber(num) {
  if (num >= 1e12) return (num / 1e33).toFixed(2) + "Dc";
  if (num >= 1e12) return (num / 1e30).toFixed(2) + "No";
  if (num >= 1e12) return (num / 1e27).toFixed(2) + "Oc";
  if (num >= 1e12) return (num / 1e24).toFixed(2) + "Sp";
  if (num >= 1e12) return (num / 1e21).toFixed(2) + "Sx";
  if (num >= 1e12) return (num / 1e18).toFixed(2) + "Qi";
  if (num >= 1e12) return (num / 1e15).toFixed(2) + "Qa";
